...
# (str) Package name
package.name = claptrigger

# (str) Package domain (needed for android/ios packaging)
package.domain = org.claptrigger
...
source.exclude_dirs = tests,.git,.buildozer,.idea,.vscode,__pycache__,bin
...
# (list) Gradle dependencies to add (same as add_jar, but for gradle dependencies)
...
# (list) Android shared libraries which will be added to AndroidManifest.xml using <uses-library> tags (shared libraries will load at their default location)
...
# (bool) enables producing multiple APKs with different architectures (and dpi)
