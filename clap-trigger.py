...
MAX_INTERVAL = 1.0
DEFAULT_APPS = [
    r"C:\Users\soyor\Desktop\Claude.lnk",
    r"C:\Users\soyor\Desktop\Visual Studio Code.lnk",
    r"C:\Users\soyor\Desktop\Spotify.lnk",
]
...
def install_startup():
    ...
    content += f'python = "{pythonw_path}"\n'
    content += f'script = "{script_path}"\n'
    content += 'cmd = """" & python & """" & " " & """" & script & """"\n'
...
def configure_ui():
    ...
    root = tk.Tk()
    root.title("Clap Trigger Config")
    ...
    tk.Button(root, text="Guardar configuración", command=save_config_ui).pack(pady=10)
